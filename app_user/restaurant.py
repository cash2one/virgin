...
index.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True, description='jwt串',
    ...
    if request.method == 'POST':
        if auto.decodejwt(request.form['jwtstr']):
            ...
            # try:
                ...
                #店粉优惠专用图片 结束
                #今日范儿店 开始
                shop_recommend = mongo.shop_recommend.find({'type':2,'get_top':'1'}).sort("addtime", pymongo.DESCENDING)[0:1]
                recommend = {}
...
restaurant.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True, description='jwt串',
                         default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
restaurant.add_parameter(name='dishes_type', parametertype='formData', type='string', required=True, description='菜系',
                         default='10')
restaurant.add_parameter(name='discount', parametertype='formData', type='string', required=True, description='优惠',
                         default='dish')
restaurant.add_parameter(name='room_people_id', parametertype='formData', type='string', required=True,
                         description='包房id', default='40')
restaurant.add_parameter(name='room_type', parametertype='formData', type='string', required=True,
                         description='包房特色 id_id_id', default='36')
restaurant.add_parameter(name='tese', parametertype='formData', type='string', required=True, description='特色 id_id_id',
                         default='51')
restaurant.add_parameter(name='pay_type', parametertype='formData', type='string', required=True,
                         description='支付 id_id_id', default='48')
restaurant.add_parameter(name='pageindex', parametertype='formData', type='string', required=True, description='页数',
                         default='1')
restaurant.add_parameter(name='x', parametertype='formData', type='string', required=True, description='经度坐标x，没有传x',
                         default='126.62687122442075')
restaurant.add_parameter(name='y', parametertype='formData', type='string', required=True, description='纬度坐标y，没有传y',
                         default='45.764067772341264')
restaurant.add_parameter(name='business_dist_id', parametertype='formData', type='string', required=True,
                         description='商圈id', default='-1')
restaurant.add_parameter(name='webuser_id', parametertype='formData', type='string', required=True,
                         description='用户id,未登录传-1', default='57396ec17c1f31a9cce960f4')
...
restaurant_img.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True, description='jwt串',
                             default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
restaurant_img.add_parameter(name='restaurant_id', parametertype='formData', type='string', required=True,
                             description='饭店ID', default='57329e300c1d9b2f4c85f8e6')
restaurant_img.add_parameter(name='type', parametertype='formData', type='string', required=True,
                             description='-1全部1菜品图2环境图3包房图', default='-1')
restaurant_img.add_parameter(name='pageindex', parametertype='formData', type='string', required=True, description='页数',
                             default='1')
restaurant_img_json = {
...
restaurant_type.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True, description='jwt串',
                              default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
    ...
    if request.method == 'POST':
        if auto.decodejwt(request.form['jwtstr']):
            try:
                ...
                data['tese'] = t_list
                data['zhifu'] = z_list
                data['youhui'] = [{'id': 'dish', 'name': '菜品优惠'}, {'id': 'wine', 'name': '酒水优惠'},
                                  {'id': 'other', 'name': '其他优惠'}]
                result = tool.return_json(0, "success", True, data)
                return json_util.dumps(result, ensure_ascii=False, indent=2)
            except Exception, e:
...
getbusiness_dist.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True,
                               description='jwt串',
                               default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
getbusiness_dist.add_parameter(name='longitude', parametertype='formData', type='string', required=True,
                               description='经度', default='126.593666')
getbusiness_dist.add_parameter(name='latitude', parametertype='formData', type='string', required=True,
                               description='纬度', default='45.706477')
...
getdistrict_list.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True,
                               description='jwt串',
                               default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
...
getbusiness_dist_byid.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True,
                                    description='jwt串',
                                    default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
getbusiness_dist_byid.add_parameter(name='id', parametertype='formData', type='string', required=True,
                                    description='行政区id', default='56d95c1f0f884d3070fbdc4f')
...
concern.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True, description='jwt串',
                      default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
concern.add_parameter(name='restaurant_id', parametertype='formData', type='string', required=True, description='饭店id',
                      default='57329e300c1d9b2f4c85f8e6')
concern.add_parameter(name='webuser_id', parametertype='formData', type='string', required=True, description='用户id',
                      default='57396ec17c1f31a9cce960f4')
concern_json = {
    ...
    if request.method == 'POST':
        if auto.decodejwt(request.form['jwtstr']):
            try:
                ...
                item = mongo.concern.find(
                    {"restaurant_id": ObjectId(restaurant_id), "webuser_id": ObjectId(webuser_id)})
                flag = True
                for i in item:
                    flag = False
                if flag:
                    mycoupons = mongo.mycoupons.find(
                        {"restaurant_id": ObjectId(restaurant_id), "webuser_id": ObjectId(webuser_id), "kind": "2"})
                    m_flag = True
                    for m in mycoupons:
                        m_flag = False
                    coupons = coupons_by({"restaurant_id": ObjectId(restaurant_id), "kind": "2",
                                          "$or": [{"button": "0"}, {"button": 0}]})
...
restaurant_info.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True, description='jwt串',
                              default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
restaurant_info.add_parameter(name='webuser_id', parametertype='formData', type='string', required=True,
                              description='用户id', default='57396ec17c1f31a9cce960f4')
restaurant_info.add_parameter(name='restaurant_id', parametertype='formData', type='string', required=True,
                              description='饭店id', default='57329e300c1d9b2f4c85f8e6')
    ...
    if request.method == 'POST':
        if auto.decodejwt(request.form['jwtstr']):
            ...
            for i in item:
                ...
                # 开团请客（暂时空着）
                kaituan = mongo.qingke.find({"nid": request.form["restaurant_id"]}).sort("time", pymongo.DESCENDING)[
                          0:1]
                data['kaituan'] = ''
                for k in kaituan:
...
pic_menu.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True, description='jwt串',
                       default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
pic_menu.add_parameter(name='type', parametertype='formData', type='string', required=True,
                       description='标签分类4全部图片5推荐菜6酒水', default='4')
pic_menu.add_parameter(name='restaurant_id', parametertype='formData', type='string', required=True, description='饭店id',
                       default='57329e300c1d9b2f4c85f8e6')
pic_menu_json = {
...
dish_menu.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True, description='jwt串',
                        default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
dish_menu.add_parameter(name='webuser_id', parametertype='formData', type='string', required=True, description='用户id',
                        default='57396ec17c1f31a9cce960f4')
dish_menu.add_parameter(name='restaurant_id', parametertype='formData', type='string', required=True,
                        description='饭店id', default='57329e300c1d9b2f4c85f8e6')
dish_menu_json = {
                ...
                "list": [
                    {
                        ...
                        "guide_image": dish_menu.String(description='图片，基本没有，留着以后用',
                                                        default="MD5MD5MD5MD5MD5MD5MD5MD5MD5MD5MD5MD5"),
...
def dish_menu():
    if request.method == 'POST':
        if auto.decodejwt(request.form['jwtstr']):
            try:
                item = mongo.restaurant.find({"_id": ObjectId(request.form['restaurant_id'])})
                item2 = mongo.order.find({'webuser_id': ObjectId(request.form['webuser_id']),
...
dish_menu_count.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True, description='jwt串',
                              default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
dish_menu_count.add_parameter(name='webuser_id', parametertype='formData', type='string', required=True,
                              description='用户id', default='57396ec17c1f31a9cce960f4')
dish_menu_count.add_parameter(name='restaurant_id', parametertype='formData', type='string', required=True,
                              description='饭店id', default='57329e300c1d9b2f4c85f8e6')
dish_menu_count.add_parameter(name='name', parametertype='formData', type='string', required=True, description='菜品名',
                              default='压锅鲤鱼')
dish_menu_count.add_parameter(name='price', parametertype='formData', type='string', required=True, description='原价',
                              default='29.8')
dish_menu_count.add_parameter(name='discount_price', parametertype='formData', type='string', required=True,
                              description='优惠价', default='29.8')
dish_menu_count.add_parameter(name='type', parametertype='formData', type='string', required=True,
                              description='类别0是菜1是酒', default='0')
dish_menu_count.add_parameter(name='num', parametertype='formData', type='string', required=True,
                              description='数量加减1或-1', default='1')
dish_menu_count.add_parameter(name='id', parametertype='formData', type='string', required=True, description='菜品id',
                              default='201605111052558357')
            ...
            # try:
                ...
                for i in item:
                    ...
                    mongo.order.update_one(pdict, {
                        "$set": {'deposit': float("%.2f" % deposit), 'dis_message': dis_message,
...
dish_menu_list.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True, description='jwt串',
                             default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
dish_menu_list.add_parameter(name='webuser_id', parametertype='formData', type='string', required=True,
                             description='用户id', default='57396ec17c1f31a9cce960f4')
dish_menu_list_json = {
                        ...
                        if dis['dis_type'] == '1':
                            y_list.append({
                                'msg': '<font size=\"3\">' + '关注即享:' + '<font size=\"3\" color=\"red\">' + str(
                                    dis['dis_amount']) + '元</font></font>',
                                'first': '关注即享:',
                                'second': str(dis['dis_amount'])
                            })
                        elif dis['dis_type'] == '2':
                            y_list.append({
                                'msg': '<font size=\"3\">' + '新粉优惠:' + '<font size=\"3\" color=\"red\">' + str(
                                    dis['dis_amount']) + '元</font></font>',
                                'first': '新粉优惠:',
                                'second': str(dis['dis_amount'])
                            })
                            ...
                            y_list.append({
                                'msg': '<font size=\"3\">' + '店粉抢优惠:' + '<font size=\"3\" color=\"red\">' + str(
                                    dis['dis_amount']) + '元</font></font>',
                                'first': '店粉抢优惠:',
                                'second': str(dis['dis_amount'])
                            })
...
getroom.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True, description='jwt串',
                      default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
getroom.add_parameter(name='webuser_id', parametertype='formData', type='string', required=True, description='用户id',
                      default='57396ec17c1f31a9cce960f4')
getroom.add_parameter(name='restaurant_id', parametertype='formData', type='string', required=True, description='饭店id',
                      default='57329e300c1d9b2f4c85f8e6')
getroom.add_parameter(name='username', parametertype='formData', type='string', required=True, description='用户名',
                      default='我叫XXX')
getroom.add_parameter(name='is_room', parametertype='formData', type='string', required=True, description='1是0否选包房',
                      default='0')
getroom.add_parameter(name='phone', parametertype='formData', type='string', required=True, description='电话',
                      default='13000000000')
getroom.add_parameter(name='demand', parametertype='formData', type='string', required=True, description='需求',
                      default='好吃便宜')
getroom.add_parameter(name='numpeople', parametertype='formData', type='string', required=True, description='用餐人数',
                      default='3')
getroom.add_parameter(name='preset_time', parametertype='formData', type='string', required=True, description='用餐时间',
                      default='2016-08-19 15:15:00')
getroom_json = {
...
settlement.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True, description='jwt串',
                         default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
settlement.add_parameter(name='order_id', parametertype='formData', type='string', required=True, description='订单id',
                         default='573153c4e0fdb78f29b42826')
settlement_json = {
...
getphone.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True, description='jwt串',
                       default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
getphone.add_parameter(name='restaurant_id', parametertype='formData', type='string', required=True, description='饭店id',
                       default='57329e300c1d9b2f4c85f8e6')
getphone_json = {
...
dish_menu_one.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True, description='jwt串',
                            default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
dish_menu_one.add_parameter(name='webuser_id', parametertype='formData', type='string', required=True,
                            description='用户id', default='57396ec17c1f31a9cce960f4')
dish_menu_one.add_parameter(name='restaurant_id', parametertype='formData', type='string', required=True,
                            description='饭店id', default='57329e300c1d9b2f4c85f8e6')
dish_menu_one_json = {
    ...
    if request.method == 'POST':
        if auto.decodejwt(request.form['jwtstr']):
            try:
                ...
                for i in item:
                    r_name = i['name']
                item2 = mongo.order.find({"restaurant_id": ObjectId(request.form['restaurant_id']),
                                          'webuser_id': ObjectId(request.form['webuser_id']), 'status': 8})
                data = {}
                list = []
                dish_list = []
                wine_list = []
...
liansuo.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True, description='jwt串',
                      default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
liansuo.add_parameter(name='district_id', parametertype='formData', type='string', required=True,
                      description='行政区id,初始传-1', default='56d7af296bff8928c07855dc')
liansuo.add_parameter(name='restaurant_id', parametertype='formData', type='string', required=True, description='饭店id',
                      default='573ad312612c5e0a6078f416')
liansuo_json = {
...
search.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True, description='jwt串',
                     default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
search.add_parameter(name='str', parametertype='formData', type='string', required=True, description='饭店名',
                     default='饭店')
search_json = {
...
hobbys.add_parameter(name='jwtstr', parametertype='formData', type='string', required=True, description='jwt串',
                     default='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJiYW9taW5nIjoiY29tLnhtdC5jYXRlbWFwc2hvcCIsImlkZW50IjoiOUM3MzgxMzIzOEFERjcwOEY3MkI3QzE3RDFEMDYzNDlFNjlENUQ2NiIsInR5cGUiOiIxIn0.pVbbQ5qxDbCFHQgJA_0_rDMxmzQZaTlmqsTjjWawMPs')
hobbys.add_parameter(name='lon', parametertype='formData', type='string', required=True, description='经度',
                     default='126.65381534034498')
hobbys.add_parameter(name='lat', parametertype='formData', type='string', required=True, description='纬度',
                     default='45.76196769636328')
hobbys_json = {
