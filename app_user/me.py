            ...
            try:
                ...
                for i in item:
                    ...
                    for dis in i['dis_message']:
                        ...
                        if dis['dis_type'] == '1':
                            y_list.append({'msg':'<font size=\"3\">'+'关注即享:'+'<font size=\"3\" color=\"red\">'+str(dis['dis_amount'])+'元</font></font>'})
                        elif dis['dis_type'] == '2':
                            y_list.append({'msg':'<font size=\"3\">'+'新粉优惠:'+'<font size=\"3\" color=\"red\">'+str(dis['dis_amount'])+'元</font></font>'})
                        elif dis['dis_type'] == '3':
                            y_list.append({'msg':'<font size=\"3\">'+'店粉抢优惠:'+'<font size=\"3\" color=\"red\">'+str(dis['dis_amount'])+'元</font></font>'})
                        else:
                            pass
                    data['youhui'] = y_list
            ...
            try:
                ...
                for i in item:
                    ...
                    if i['status'] == 'wait_friends':
                        ...
                        json['time'] = '<font size=\"4\" color=\"#feb71d\">'+'距离活动结束还有'+'</font><font size=\"7\" color=\"red\">'+str(int((i['end_time']-datetime.datetime.now()).total_seconds()/60))+'</font><font size=\"4\" color=\"yellow\">'+'分钟'+'</font>'
                        json['status'] = '邀请好友进行时'
                        json['people_num'] ='<font size=\"4\">还有'+'</font><font size=\"7\" color=\"red\">'+str(i['max_group'] - len(i['friends']))+'</font><font size=\"4\">'+'名好友待邀请</font>'
