            ...
            try:
                ...
                for i in item:
                    ...
                    if i['status'] == 'wait_friends':
                        ...
                        json['time'] = '<font size=\"2\" color=\"yellow\">'+'距离活动结束还有'+'</font><font size=\"4\" color=\"red\">'+str(int((i['end_time']-datetime.datetime.now()).total_seconds()/60))+'</font><font size=\"2\" color=\"yellow\">'+'分钟'+'</font>'
                        json['status'] = '邀请好友进行时'
                        json['people_num'] ='<font size=\"2\">还有'+'</font><font size=\"4\" color=\"red\">'+str(i['max_group'] - len(i['friends']))+'</font><font size=\"2\">'+'名好友待邀请</font>'
                        ...
                        json['time'] = '<font size=\"2\" color=\"yellow\">'+'已就餐'+'</font>'
                        json['status'] = '已就餐'
                        json['people_num'] =i['max_group'] - len(i['friends'])
                    elif i['status'] == 'timeout':
                        json['time'] = '<font size=\"2\" color=\"yellow\">'+'活动已结束'+'</font>'
                        json['status'] = '已超时'
