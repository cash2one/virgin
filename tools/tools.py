    ...
    def rebuild(self):
        ...
        for menu in rebuild_data['menu']:
            ...
            for key in menu.keys():
                if key == 'dishs':
                    dishs = []
                    if menu['name'] != '优惠菜' and menu['name'] != '推荐菜' and menu['dish_type'] == '1' and menu[
                        'dishs'] != []:
                        for dish in menu['dishs']:
                            try:
                                if 'id' in dish.keys():
...
def tuisong(mfrom='', mto='', title='', info='', goto='', channel='', type='', totype='',
    ...
    print identandroid, identios,'111111111111111111'
    issave = True
    # 阿里网关参数安卓
    androidmsg = {}
    # 阿里网关参数IOS
    ...
    if data_id != '-1':
        insertjson['data_id'] = '57830a067c1fa4826dce8fc3'
    else:
